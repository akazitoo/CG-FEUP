...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/mytext1.vert", "shaders/mytext1.frag"),
			new CGFshader(this.gl, "shaders/mytext2.vert", "shaders/mytext1.frag"),
			new CGFshader(this.gl, "shaders/mytext1.vert", "shaders/mytext3.frag"),
